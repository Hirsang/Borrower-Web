...
const { login, username, password, borrowerdashboard, generateIdCardNumber, generatePhoneNumber, generateRandomName, generateEmail, generateIdNPWPNumber, generateSIUPNumber, Data1, Data2, Data3, MaxSize, FilePDF, generateNama, nama, name } = require("../../RunConfig");
...
describe('EKYC-Borrower-Personal', ()=> {
    ...
    //     cy.wait(500).xpath("//button[@aria-label='menu']").click()
